...
<div class="login-container">
    ...
    <form method="POST" action="{{ route('login.submit') }}">
        ...
        <div id="usernameLoginInput" style="display:none;">
            ...
            <input type="text" id="loginUsername" name="userUsername" required>
        </div>
...
<script>
    function toggleLoginInput() {
        ...
        var emailInput = document.querySelector('#emailLoginInput input');
        var usernameInput = document.querySelector('#usernameLoginInput input');

        if (role === 'public') {
            document.getElementById('emailLoginInput').style.display = '';
            document.getElementById('usernameLoginInput').style.display = 'none';

            // Enable email input validation
            emailInput.required = true;
            emailInput.disabled = false;
            emailInput.name = 'userEmail';

            // Disable username input validation
            ...
            // Disable email input validation
            emailInput.required = false;
            emailInput.disabled = true;
            emailInput.name = '';
            emailInput.value = '';

            // Enable username input validation
